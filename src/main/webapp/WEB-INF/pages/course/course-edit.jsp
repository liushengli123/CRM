        ...
        <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_email" value="${course.courseName}"
                         name="courseName"
                         required=""
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="number" value="${course.coursePrice}" id="L_username"
                         name="coursePrice"
                         required=""
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="number" value="${course.courseCount}" id="L_pass"
                         name="courseCount"
                         required=""
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <textarea name="courseDesc" placeholder="请输入课程简介"
                          required=""
                          class="layui-textarea">${course.courseDesc}</textarea>
              </div>
          </div>
          <div class="layui-form-item">
              <label class="layui-form-label">
